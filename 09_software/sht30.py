...
import time
# Modified from the original by AJB and by RobertHH (forum.micropython.org)
# using soft i2c, since hard gets errors
__version__ = '0.2.3'
__author__ = 'Roberto Sanchez'
__license__ = "Apache License 2.0. https://www.apache.org/licenses/LICENSE-2.0"

# I2C address B 0x45 ADDR (pin 2) connected to VDD   # Changed to 44 by AJB
