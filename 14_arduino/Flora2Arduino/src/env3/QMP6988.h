// Vendored from M5Unit-ENV/src/QMP6988.h (MIT License, M5Stack).
#ifndef __QMP6988_H
#define __QMP6988_H
...
typedef struct {
    ...
    QMP6988_S16_t COE_a1, COE_a2;
    QMP6988_S32_t COE_b00;
    QMP6988_S16_t COE_bt1, COE_bt2, COE_bp1, COE_b11;
    QMP6988_S16_t COE_bp2, COE_b12, COE_b21, COE_bp3;
} qmp6988_cali_data_t;
...
typedef struct {
    uint8_t slave, chip_id, power_mode;
