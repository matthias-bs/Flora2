// Vendored from M5Unit-ENV/src/I2C_Class.h (MIT License, M5Stack).
// Copied into the sketch tree so that only SHT3X + QMP6988 are compiled,
// avoiding the M5UnitUnified framework and its cascading dependencies.
